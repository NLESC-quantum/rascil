            ...
            if vis.npol == 1:
                ...
                for sub_vis_row in range(original.shape[0]):
                    for chan in range(nchan):
                        ...
                        antantwt = numpy.einsum(
                            "i,j->ij", gainwt[:, chan, 0, 0], gainwt[:, chan, 0, 0]
                        )
                        appliedwt[sub_vis_row, :, :, chan, 0] = antantwt
                        applied[sub_vis_row, :, :, chan, 0][antantwt == 0.0] = 0.0
                            ...
                            for a2 in range(a1 + 1, vis.nants):
                                for chan in range(nchan):
                                    if (
                                        ...
                                        cfs = numpy.diag(
                                            original[sub_vis_row, a2, a1, chan, ...]
                                        )
                                        applied[
                                            sub_vis_row, a2, a1, chan, ...
                                        ] = numpy.diag(
                                            igain[a1, chan, :, :]
                                            @ cfs
                                            @ cigain[a2, chan, :, :]
                ...
                print(
                    "No row in gaintable for visibility time range  {} to {}".format(
