...
def create_named_configuration(name: str = "LOWBD2", **kwargs) -> Configuration:
    ...
    if name == "LOWBD2":
        ...
        fc = create_configuration_from_MIDfile(
            antfile=rascil_data_path("configurations/mkatplus.cfg"),
        ...
        location = EarthLocation(
            lon=+116.6356824 * u.deg, lat=-26.7013006 * u.deg, height=377.0 * u.m
        )
        log.debug(
            "create_named_configuration: %s\n\t%s\n\t%s"
            % (name, location.geocentric, location.geodetic)
        ...
        fc = create_configuration_from_MIDfile(
            antfile=rascil_data_path("configurations/askap.cfg"),
            vp_type="ASKAP",
            mount="equatorial",
            name=name,
            location=location,
        ...
        fc = create_configuration_from_MIDfile(
            antfile=rascil_data_path("configurations/lofar.cfg"),
            location=location,
            mount="XY",
            vp_type="LOFAR",
            name=name,
