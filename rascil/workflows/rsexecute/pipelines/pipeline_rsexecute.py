...
def ical_list_rsexecute_workflow(
    vis_list,
    model_imagelist,
    context,
    vis_slices=1,
    ...
    **kwargs
    ...
    if do_selfcal:
        ...
        predicted_model_vislist = predict_list_rsexecute_workflow(
            model_vislist,
            model_imagelist,
            context=context,
            vis_slices=vis_slices,
        ...
        residual_imagelist = invert_list_rsexecute_workflow(
            cal_vis_list,
            model_imagelist,
            context=context,
            dopsf=False,
    ...
    if nmajor > 1:
        for cycle in range(nmajor):
            if do_selfcal:
                model_vislist = predict_list_rsexecute_workflow(
                    model_vislist,
...
def continuum_imaging_list_rsexecute_workflow(
    vis_list, model_imagelist, context, gcfcf=None, vis_slices=1, facets=1, **kwargs
):
...
def spectral_line_imaging_list_rsexecute_workflow(
    ...
    **kwargs
    ...
    return continuum_imaging_list_rsexecute_workflow(
        vis_list,
        model_imagelist,
        context=context,
        gcfcf=gcfcf,
