master
------
* Bug Fix for calculation of radius in rascil.processing_components.visibility.blockvisibility_select_r_range and reinstatement of rmax parameter in sensitivity app
