...
__all__ = ['convert_blockvisibility_to_xblockvisibility',
           'convert_xblockvisibility_to_blockvisibility']
...
from rascil.data_models.memory_data_models_xarray import XBlockVisibility

log = logging.getLogger('logger')


def convert_blockvisibility_to_xblockvisibility(vis: BlockVisibility) -> XBlockVisibility:
    ...
    return XBlockVisibility(frequency=vis.frequency,
...
def convert_xblockvisibility_to_blockvisibility(xvis: XBlockVisibility) -> BlockVisibility:
