...
def apps_parser_imaging(parser):
    ...
    parser.add_argument('--imaging_context', type=str, default='ng',
                        help="Imaging context i.e. the gridder used 2d | ng")
    parser.add_argument('--imaging_ng_threads', type=int, default=4,
                        help='Number of Nifty Gridder threads to use (4 is a good choice)')
    parser.add_argument('--imaging_w_stacking', type=str, default=True,
...
def apps_parser_cleaning(parser):
    ...
    parser.add_argument('--clean_scales', type=int, nargs="*", default=[0],
                        help='Scales for multiscale clean (pixels) e.g. [0, 6, 10]')
    parser.add_argument('--clean_nmoment', type=int, default=4,
                        help='Number of frequency moments in mmclean (1 is a constant, 2 is linear, etc.)')
    parser.add_argument('--clean_nmajor', type=int, default=5,
                        help='Number of major cycles in cip or ical')
    parser.add_argument('--clean_niter', type=int, default=1000,
                        help='Number of minor cycles in CLEAN (i.e. clean iterations)')
    parser.add_argument('--clean_psf_support', type=int, default=256,
                        help='Half-width of psf used in cleaning (pixels)')
    parser.add_argument('--clean_gain', type=float, default=0.1,
    ...
    parser.add_argument('--clean_overlap', type=int, default=32, help='Overlap of facets in clean (pixels)')
