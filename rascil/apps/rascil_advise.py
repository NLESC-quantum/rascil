...
def cli_parser():
    ...
    parser = argparse.ArgumentParser(
        description="RASCIL imaging advise", fromfile_prefix_chars="@"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--dela", type=float, default=0.02, help="Maximum allowed decorrelation"
    )
