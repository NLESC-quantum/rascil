...
def analyze_image(args):
    ...
    input_image = args.ingest_fitsname_restored
    ...
    ci_checker(input_image, input_image_residual, beam_info, source_file, th_isl, th_pix)
...
def ci_checker_diagnostics(bdsf_image, input_image_residual):
    """
    ...
    save_hist = input_image_residual.replace(
...
def ci_checker(input_image, input_image_residual, beam_info, source_file, th_isl, th_pix):
    """
    ...
    ci_checker_diagnostics(img_resid, input_image_residual)
