...
def simulation(args):
    ...
    log.info(
        "Time to write BlockVisibility as HDF5 = {:.3f} seconds".format(hdf5_writetime)
    )
    ...
    log.info(
        "Time to write BlockVisibility as MS = {:.3f} seconds".format(ms_writetime)
    )
...
def cli_parser():
    ...
    parser.add_argument(
        "--nchan", type=int, default=8, help="Number of frequency channels"
    )
    parser.add_argument(
