...
class GainTable:
    ...
    def __init__(
        ...
        if data is None and gain is not None:
            ...
            desc = [
                ("gain", "c16", (nants, nchan, nrec, nrec)),
...
class PointingTable:
    ...
    def __init__(
        ...
        if data is None and pointing is not None:
            ...
            assert len(frequency) == nchan, "Discrepancy in frequency channels"
            desc = [
                ("pointing", "f16", (nants, nchan, nrec, 2)),
...
class GridData:
    ...
    def __init__(
        self, data=None, grid_wcs=None, projection_wcs=None, polarisation_frame=None
    ):
        """Create Griddata
    ...
    def phasecentre(self):
        ...
        return SkyCoord(
            self.projection_wcs.wcs.crval[0] * u.deg,
            self.projection_wcs.wcs.crval[1] * u.deg,
        )
